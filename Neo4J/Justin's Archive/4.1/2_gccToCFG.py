...
cfg_files_dir = "/home/spire2/SPIRE_GLLeN/Neo4J/cfg_files_newDB"
c_badfiles_dir = "/home/spire2/SPIRE_GLLeN/Neo4J/c_badfiles_newDB"
asm_files_dir = "/home/spire2/SPIRE_GLLeN/Neo4J/asm_files_newDB"
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            result_asm = subprocess.run(
                gcc_asm_command, check=True, capture_output=True, text=True
            )
            ...
            if os.path.exists(generated_asm_file):
                ...
                logger.error(
                    f"ASM file was not generated as expected for '{c_file_path}'. Moving to bad files directory."
                )
                shutil.move(
                    c_file_path,
                    os.path.join(bad_files_dir, os.path.basename(c_file_path)),
