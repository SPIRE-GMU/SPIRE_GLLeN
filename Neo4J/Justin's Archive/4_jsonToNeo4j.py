...
def insert_data_into_neo4j(cfg_data):
    with driver.session() as session:
        for file_path, function_data in cfg_data.items():
            ...
            s_file_path = os.path.join('/home/spire2/SPIRE_GLLeN/Neo4J/asm_files', f"{function_name}.s")
            c_file_path = os.path.join('/home/spire2/SPIRE_GLLeN/Neo4J/c_files', f"{function_name}.c")
