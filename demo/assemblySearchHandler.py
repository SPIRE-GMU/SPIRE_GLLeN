...
def main():
    ...
    print(f"Passing {source_asm} to Model:")

    # print("\n\n\n\n+++++++++++++++++++++++++++++++++++++++")
    # print(model_input)

    results = querryModel(model_input)
    # print(results)
    ...
    print("Results written to output/count_alpha_digit_out.c")
    return results
...
def testCase():
    ...
    otherFile = "justin/sum_filtered_ranges.c"
