...
def main():
    ...
    accelerator = Accelerator(mixed_precision="fp16")  # Use FP16 for memory optimization
    ...
    c_func_decompile = tokenizer.decode(outputs[0][len(inputs['input_ids'][0]):], skip_special_tokens=True)
